...
$nazigamye = htmlentities($_POST['nazigamye'], ENT_QUOTES);
$ahoyeraturutse = htmlentities($_POST['ahoyeraturutse'], ENT_QUOTES);
$itariki_nyazigamye = htmlentities($_POST['itariki_nyazigamye'], ENT_QUOTES);

$item_id = htmlentities($_POST['item_id'], ENT_QUOTES);
$employee_id = $_SESSION['employee_id'];

$doSQL = "UPDATE kwizigamira SET amafaranga_ariho =amafaranga_ariho+'$nazigamye' WHERE item_id = '$item_id' AND employee_id=".$_SESSION['employee_id']."";

mysql_query($doSQL) or die(mysql_error());

$doSQL2 = "INSERT INTO kuzigama_amafaranga (item_id, nazigamye,  ahoyeraturutse,  itariki_nyazigamye, employee_id) VALUES ('$item_id', '$nazigamye', '$ahoyeraturutse', '$itariki_nyazigamye' , '$employee_id')";
...
<div id="smallwrap">
  <div id="header">
    <h2>ANDIKA AMAFARANGA WAZIGAMYE</h2>
  ...
  <div id="content">
    <form id="kubikuza" name="kubikuza" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
	  ...
	  <tr>
        ...
        <tr>
          <td class="firstcell">amafaranga nazigamye </td>
          <td colspan="2">: 
            <input name="nazigamye" type="text" class="entrytext" id="nazigamye" value="" /></td>
        </tr>
        <tr>
          <td class="firstcell">Aho yaraturutse </td>
          <td colspan="2">: 
            <input name="ahoyeraturutse" type="text" class="entrytext" id="ahoyeraturutse" value="" /></td>
        </tr>
        <tr>
          <td class="firstcell">Itariki nayazigamyeho </td>
          <td>: 
            <input name="itariki_nyazigamye" type="text" class="entrytext" id="itariki_nyazigamye" size="15"  value="" onFocus="showCalendarControl(this);"/></td>
        </tr>
        <tr>
