...
//Colors and styles       (all colors can be array (R,G,B) or named color)
    ...
    var $light_grid_color = '#006666';
    var $tick_color = 'black';
    var $title_color = 'black';
    var $data_colors = array('#2B8C37');
    ...
    var $dashed_style = '2-0';              // colored dots-transparent dots
...
/////////////////////////////////////////////
    ...
    function SetDefaultFonts()
    {
        ...
        return $this->SetFont('generic', 2)
            ...
            && $this->SetFont('x_label', 3)
            && $this->SetFont('y_label', 3)
            && $this->SetFont('x_title', 4)
            && $this->SetFont('y_title', 4);
    }
