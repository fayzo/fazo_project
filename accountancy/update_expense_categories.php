...
$get_expense_categories = mysql_query("SELECT * FROM expense_categories WHERE employee_id=".$_SESSION['employee_id']." ORDER BY name Asc");
...
$doSQL = "INSERT INTO expense_categories (name,employee_id) VALUES ('$name','$employee_id')";
...
<div id="smallwrap">
  <div id="header">
    <h2>IBYICIRO BY' AMAFARANGA ASOHOKA </h2>
   
  </div>
  <div id="content">
    <form id="ibyiciro" name="ibyiciro" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" onSubmit="return validateFormOnSubmit(this)">
      <table class="fulltable">
        <tr>
          ...
          <td><p>
            ...
            <p>Urugero: Imyambaro, Amafaranga yishuri,...  </p></td>
        </tr>
        <tr>
      ...
      <table class="fulltable">
        <tr>
          <td width="10%" class="tabletop">Gusiba</td>
          <td class="tabletop">Izina ry' icyiciro:</td>
        </tr>
        <?php while($show_expense_category = mysql_fetch_array($get_expense_categories)) { ?>
        <tr class="tablelist">
          <td class="tablerowborder"><a href="delete_expense_category.php?category_id=<?php echo $show_expense_category['category_id'] ?>" onClick="return confirm('Urifuza koko gusiba: <?php echo $show_expense_category['name'] ?> ?')"><img src="../images/icons/delete.png" alt="GUSIBA" width="16" height="16" class="iconspacer" /></a></td>
