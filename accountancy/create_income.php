...
$doSQL = "INSERT INTO incomes (category_id, reason,  amount,  date_received, employee_id) VALUES ('$category_id', '$reason', '$amount', '$date_received' , '$employee_id')";
...
<div id="smallwrap">
  <div id="header">
    <h2>andika uko amafaranga yinjiye </h2>
      ...
      <table class="fulltable">
        <tr>
          ...
          <td><select name="category_id" class="entrytext" id="category_id">
            ...
            <option value="<?php echo $show_income_category['name'] ?>"><?php echo $show_income_category['name'] ?></option>
            <?php } ?>
          </select></td>
        </tr>
        <tr>
          <td class="firstcell">Aho aturutse :</td>
